...
// Nx claude generator so the delta is one-model. No spec sent — Python is assumed known (the asymmetry is
// the whole point: Nx must be learnable from a small spec; Python the model already has).
const fs = require('fs');
