...
exports.generate = function (task, opts) {
  return new Promise((resolve, reject) => {
    ...
    const prompt =
      'You write ONLY Nx code — no prose, no explanation. Nx is defined ENTIRELY by this spec (do not assume Python/JS semantics). ' +
      ...
      spec +
      '\n\n=== TASK ===\n' + task.prompt +
      '\n\nReturn ONE ```nx code block containing only the Nx solution (define exactly the agents the task names).';
