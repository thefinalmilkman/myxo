'use strict';
// nx-live-worker.js — the Worker half of nx-live. It runs the (synchronous) Nx script,
...
const client = {
  tools,
  // synchronous from Nx's view: post -> block -> read the answer the parent left us
  call(name, args) {
