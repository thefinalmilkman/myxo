'use strict';
// Local Ollama generator for the PYTHON CONTROL group — FREE. Same model as the Myxo ollama generator, so the
// Myxo-vs-Python delta is measured on ONE model. No spec is sent (Python is assumed known); that asymmetry is
// the point — Myxo must be learnable from a small spec, Python the model already knows.
